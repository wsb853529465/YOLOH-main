...
def parse_args():
    ...
    # model
    parser.add_argument('-v', '--version', default='yoloh50', choices=['yoloh18', 'yoloh50', 'yoloh50-DC5', \
                                                                       'yoloh101', 'yoloh101-DC5', 'yoloh50-DC5-640'],
                        help='build yoloh')
...
def test(args,
    ...
    for index in range(num_images):
        ...
        for _, bbox in enumerate(bboxes):
            sheet.write(x_num, y_num, str(bbox))
            x_num += 1
            if x_num == 50000:
                x_num = 1
                y_num += 1
